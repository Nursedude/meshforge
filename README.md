...
| **Multi-Mesh Gateway** | Meshtastic ↔ RNS/LXMF bridge via MQTT, composable-bridges model, refusal-on-inconsistency preflight, persistent SQLite queue. Field-deployed on moc / moc1 / moc2 / moc3 / volcanoai 2026-04-24 |
| **Gateway + RNode** | rnsd RNodeInterface on USB LoRa radio alongside Meshtastic HAT; RNS-LoRa egress at 903.625 MHz / SF7 — validated on moc3 |
...
Active gateway fleet (as of 2026-04-24): **moc**, **moc1**, **moc2**, **moc3**, **volcanoai** — all on the composable-bridges model below.
