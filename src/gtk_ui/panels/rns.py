...
class RNSPanel(Gtk.Box):
    ...
    def _build_rnode_config_section(self, parent):
        ...
        self.rnode_bw = Gtk.DropDown.new_from_strings(["7.8 kHz", "10.4 kHz", "15.6 kHz", "20.8 kHz", "31.25 kHz", "41.7 kHz", "62.5 kHz", "125 kHz", "250 kHz", "500 kHz"])
    ...
    def _update_rnode_ui(self, config):
        ...
        if 'bandwidth' in config:
            ...
            bw_map = {7800: 0, 10400: 1, 15600: 2, 20800: 3, 31250: 4, 41700: 5, 62500: 6, 125000: 7, 250000: 8, 500000: 9}
    ...
    def _launch_nomadnet(self, mode):
        ...
        try:
            if mode == "textui":
                ...
                # Use --config for NomadNet config dir (~/CONFIG has working RNS setup)
                nomadnet_config = real_home / "CONFIG"
