...
VERSION_HISTORY = [
    {
        ...
        "changes": [
            ...
            "GATEWAY: Fleet deployment — moc, fleet-host-1, fleet-host-2 gateways installed and field-validated; fleet-host-3 confirmed running with RNodeInterface on 903.625 MHz LoRa egress (gateway → rnsd → RNode pipeline).",
