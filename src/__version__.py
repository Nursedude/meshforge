...
VERSION_HISTORY = [
    ...
    },
    {
        ...
        "changes": [
            ...
            "GATEWAY: `connection_type=\"serial\"` on `MeshtasticConfig` — dual-radio gateways now bridge a HAT-attached primary with a USB-attached Meshtastic secondary (no second meshtasticd needed). Live-probed against a Heltec V3 in the development fleet.",
            ...
            "GATEWAY: Fleet deployment — gateways installed and field-validated across multiple development boxes; one box confirmed running with RNodeInterface on a regional LoRa frequency (gateway → rnsd → RNode pipeline).",
