...
# ============================================================================
# CONNECTIVITY & DIAGNOSTICS (extracted to _rns_connectivity.py)
# ============================================================================

from commands._rns_connectivity import (
    check_connectivity, test_path, get_path_info,
)
...
# ============================================================================
# RNS CLIENT INITIALIZATION & NODE DISCOVERY (extracted to _rns_connectivity.py)
# ============================================================================

from commands._rns_connectivity import (  # noqa: E402
    _init_rns_client, list_known_destinations, discover_nodes,
)
