...
# Interface templates extracted to rns_templates.py — re-exported for backward compat
from commands.rns_templates import (  # noqa: F401
    get_interface_templates, apply_template, apply_multi_template,
)
