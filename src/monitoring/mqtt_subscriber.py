...
# Factory functions + singleton (extracted to _mqtt_subscriber_factory.py)
from monitoring._mqtt_subscriber_factory import (  # noqa: E402 — re-export for backward compat
    create_local_subscriber,
    create_public_subscriber,
    get_local_subscriber,
    start_local_subscriber,
    stop_local_subscriber,
)
