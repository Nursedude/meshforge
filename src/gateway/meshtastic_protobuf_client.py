...
# ---------------------------------------------------------------------------
# Stateless TX + Singleton (extracted to _protobuf_client_helpers.py)
# ---------------------------------------------------------------------------
from gateway._protobuf_client_helpers import (  # noqa: E402 — re-export for backward compat
    _next_stateless_packet_id,
    send_text_direct,
    get_protobuf_client,
