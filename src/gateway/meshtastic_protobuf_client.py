...
from ._protobuf_admin import ProtobufAdminMixin
...
class MeshtasticProtobufClient(ProtobufAdminMixin):
    """
    ...
    # Admin messages, config R/W, channels, owner, traceroute, position,
    # and cached state accessors are provided by ProtobufAdminMixin
    # (see _protobuf_admin.py).
