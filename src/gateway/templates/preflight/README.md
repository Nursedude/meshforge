...
| File | Use case |
|------|----------|
| `shortturbo_slot8_meshforge.json` | MeshForge moc3 reference config: HAT on US/SHORT_TURBO/slot 8 bridged via a dedicated 'meshforge' MQTT channel. First field-validated 2026-04-18. |
