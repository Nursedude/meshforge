...
Usage:
    # Send to moc3's gateway LXMF source hash, default text
    python3 scripts/validate_rns_to_mesh.py --to f68c2f56cb61527b6c9ad603b9a5009a

    # Custom text + longer path-request window + delivery wait
    python3 scripts/validate_rns_to_mesh.py \\
        --to f68c2f56cb61527b6c9ad603b9a5009a \\
