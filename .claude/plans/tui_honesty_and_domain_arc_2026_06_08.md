...
- [ ] **Broader `.save()` sweep (deferred S5)** — `SettingsManager.save()` bool discarded in `automation.py` ×9 / `first_run.py` ×1 (meshcore ×2 now done via M1/M2). Separate focused audit.
