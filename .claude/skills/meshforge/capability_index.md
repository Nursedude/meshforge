...
| `weather` | Space Weather — Propagation & HF bands |  | sweep | ◐ 2026-09-25 dev/manager box | PropagationHandler |
...
| `config` | View Reticulum Config |  | sweep | ✓ 2026-09-25 dev/manager box | RNSConfigHandler |
