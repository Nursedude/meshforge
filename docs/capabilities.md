...
|----------|-------------|
| **TUI Interface** | Installer, service control, device config wizard, gateway config, diagnostics — <!--STAT:handlers-->101<!--/STAT--> handler modules via registry pattern |
...
for the live count) across <!--STAT:testfiles-->365<!--/STAT--> test files. However, automated tests
