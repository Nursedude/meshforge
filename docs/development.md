...
**~11,000 tests** across <!--STAT:testfiles-->373<!--/STAT--> test files. Selected high-volume files
...
- Handler registry pattern: all <!--STAT:handlers-->101<!--/STAT--> TUI handler modules use registry dispatch (mixin inheritance fully replaced)
