...
**~11,000 tests** across <!--STAT:testfiles-->419<!--/STAT--> test files. Selected high-volume files
...
- Handler registry pattern: all <!--STAT:handlers-->84<!--/STAT--> TUI handlers use registry dispatch (mixin inheritance fully replaced)
